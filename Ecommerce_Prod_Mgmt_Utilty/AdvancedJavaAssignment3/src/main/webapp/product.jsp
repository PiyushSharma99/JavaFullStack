...
<body style="margin-left: 20px; margin-right: 20px;">
	...
	<div>
		...
		if (totalSize > 10) {
			...
			out.println("<div class='alert'>" + "<span class='closebtn'>&times;</span>" + "<strong>" + danger + "</strong>"
			+ message + "" + "</div>");
		}
		%>
	</div>
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" name="quantity"
							onchange="validateQuantity(this.value)"> <span
							id="numberText1"></span></td>
					</tr>
					<tr>
						<td>Size</td>
						<td><input type="text" name="size"
							onchange="validateSize(this.value)"> <span
		...
		<div>
			...
			<table class='product-table' style='width: 100%'>
				...
				for (int i = 0; i < li.size(); i++) {
					...
					out.println("<td class = 'product-table' id=" + titleClassNameWithRow + " width='200px' height = '200px'>" + title
					+ "</td>");
					out.println("<td class = 'product-table' id=" + quantityClassNameWithRow + " width='100px' height = '100px'>"
					+ quantity + "</td>");
					out.println("<td class = 'product-table' id=" + sizeClassNameWithRow + " width='100px' height = '100px'>" + size
					+ "</td>");
					out.println("<td class = 'product-table image-data' id=" + previewClassNameWithRow
					+ " width='200px' height = '200px'><img width='150px' height = '150px' src = '" + preview + "'></td>");
					out.println("<td class = 'product-table' width='200px' height = '200px' id=" + actionClassNameWithRow + ">"
					+ "<input type='button' id='edit_button" + row_id + "' value='Edit' class='edit' onclick='edit_row("
					+ row_id + ")'> &nbsp " + "<input type='button' id='save_button" + row_id
					+ "' value='Save' class='save' onclick='save_row(" + row_id + ")'> &nbsp"
					+ "<input type='button' id='delete_button" + row_id + "' value='Delete' class='delete' onclick='delete_row("
					+ row_id + ")'>" + "</td>");
					out.println("</tr>");
				}
				%>
