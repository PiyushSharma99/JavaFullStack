...
//        String directoryPath = currentWorkingDir + Constants.FOLDER_NAME;
        ...
        String directoryPath =  Constants.FOLDER_NAME;
...
//            System.out.println("Nqme of file" + nameOfFiles);
    ...
    private void addCSVFileData () throws IOException {
        TshirtDaoHibernate tshirtDao = null;
        for (String filename : newFiles) {
            Map<String, Set<Tshirt>> tshirtData = readDataFromCsvFile(filename);
            tshirtDao = new TshirtDaoHibernate();

            for (Map.Entry<String, Set<Tshirt>> tshirt : tshirtData.entrySet())
            {
//                for(Tshirt tshirt1 : tshirt.getValue()) {
//                    System.out.println(tshirt1.getId());
//                }
